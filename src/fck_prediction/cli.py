...
def main():
    ...
    from fck_prediction.config import OUTPUT_DIR
    print(f"\n📁 ARQUIVOS GERADOS em: {OUTPUT_DIR}/")
    print("   results/            – Excel com todos os resultados")
    print("   results/shap/       – Resultados SHAP por modelo")
    print("   results/mcs/        – Model Confidence Set")
    print("   datasets/           – Datasets DEV otimizados por modelo")
    print("   figures/monte_carlo/        – Monte Carlo original e otimizado")
    print("   figures/cross_validation/   – Repeated CV boxplots e heatmaps")
    print("   figures/taylor/             – Taylor Diagrams")
    print("   figures/performance/        – Boxplots, violin, error variance")
    print("   figures/radar/              – Radar Charts (3 versões)")
    print("   figures/learning_curves/    – Learning Curves (all, gap, best/worst)")
    print("   figures/permutation_importance/ – Heatmap, barras, SHAP vs Perm, boxplot")
    print("   figures/pdp/                – PDPs 1D (all features, top3) + 2D")
    print("   figures/qq_plots/           – Q-Q plots, histogramas, boxplot, Shapiro")
    print("   figures/shap/               – SHAP bar, summary, dependence")
